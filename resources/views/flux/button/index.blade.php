...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'outline' => 'bg-white hover:bg-orange-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75',
    ...
    ->add(match ($variant) { // Text color...
        ...
        'outline' => 'text-orange-500 dark:text-orange-400',
        'danger' => 'text-white',
    ...
    ->add(match ($variant) { // Border color...
        ...
        'outline' => 'border border-orange-500 hover:border-orange-600 border-b-orange-500 dark:border-orange-400 dark:hover:border-orange-500',
         default => '',
    })
