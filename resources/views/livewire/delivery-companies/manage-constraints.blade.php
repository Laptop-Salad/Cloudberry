    ...
    <flux:modal wire:model="show" class="w-6xl">
        ...
        <form wire:submit="addConstraint" class="mt-6 space-y-6">
            ...
            >
                ...
                <flux:select.option :value="'delivery_condition'">
                    Delivery Condition
                </flux:select.option>
            </flux:select>
            ...
            >
                ...
                @foreach(\App\Enums\ConstraintType::deliveryCompanyConstraints() as $constraint)
        ...
        @isset($this->delivery_company)
            ...
            <table class="basic-table mt-4">
                ...
                <tbody>
                @foreach($this->delivery_company->constraints as $type => $condition)
                    <tr>
